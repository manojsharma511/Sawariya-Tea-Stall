      ...
      {editingItem && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 border border-gray-100 shadow-2xl relative animate-scale-in max-h-[90vh] flex flex-col my-auto">
            ...
            <h3 className="font-heading text-xl font-bold text-secondary mb-4 flex items-center gap-2 shrink-0">
              <Edit2 size={18} className="text-saffron" />
              <span>Edit Testimonial</span>
            </h3>

            <form onSubmit={handleSaveEdit} className="space-y-4 overflow-y-auto pr-1 flex-grow">
              <div>
